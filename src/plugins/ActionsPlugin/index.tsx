      ...
      <button
        ...
        onClick={() => {
          editor.update(() => {
            ...
            window.navigator.clipboard.writeText(markdown).then(() => {
      ...
      <button
        ...
        onClick={() => {
          editor.update(() => {
            ...
            window.navigator.clipboard.writeText(htmlString).then(() => {
              showFlashMessage("HTML copied to clipboard");
            });
          });
        }}
        title="Share HTML"
        aria-label="Share HTML"
      >
        <i className="share" />
      </button>
      <button
